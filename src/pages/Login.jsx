...
{error && (
  <p className="text-sm text-red-500 p-3 rounded-xl bg-red-50 mb-6">{error}</p>
          ...
          <div className="space-y-4">
            ...
            <a 
              href="/admin/login" 
              className="block w-full rounded-xl border-2 border-slate-200/50 bg-gradient-to-r from-slate-50 to-slate-100 px-6 py-3.5 text-sm font-semibold text-slate-700 hover:bg-slate-100 hover:border-slate-300 hover:shadow-md transition-all text-center"
            >
              Admin Login →
            </a>
          </div>
